...
<div class="container-fluid">
	...
	?>
		<form class="form-neon FormulariosAjax" action="<?php echo SERVERURL; ?>ajax/clienteAjax.php" method="POST" data-form="update" autocomplete="off">
			<fieldset>
					...
					<div class="row">
						<div class="col-12 col-md-6">
							<div class="form-group">
								...
								<input type="text" pattern="[0-9-]{1,27}" class="form-control" name="cliente_dni_up" id="cliente_dni" maxlength="27" value="<?php echo $campos['cliente_dni']; ?>">
							</div>
						</div>
						<div class="col-12 col-md-6">
							<div class="form-group">
