...
?>
			<div class="container-fluid">
				<form class="form-neon FormulariosAjax" action="<?php echo SERVERURL; ?>ajax/buscadorAjax.php" method="POST" data-form="default" autocomplete="off">
					<div class="container-fluid">
...
?>			
			<div class="container-fluid">
				<form class="form-neon FormulariosAjax" action="<?php echo SERVERURL; ?>ajax/buscadorAjax.php" method="POST" data-form="search" autocomplete="off">
...
echo $ins_cliente->paginador_cliente_controlador($pagina[1],10,$_SESSION['privilegio_spm'],$pagina[0],$_SESSION['busqueda_cliente']);
?>	
